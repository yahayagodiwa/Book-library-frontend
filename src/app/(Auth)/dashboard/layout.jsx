...
const navLinks = [
  { label: "Dashboard", href: "/dashboard", icon: <MdSpaceDashboard size={20} /> },
  { label: "Profile", href: "/dashboard/profile", icon: <FaUser size={20} /> },
  { label: "My Books", href: "/dashboard/books", icon: <FaBookOpenReader size={20} /> },
  { label: "Fines", href: "/dashboard/fines", icon: <span className="text-xl">💰</span> },
  { label: "Settings", href: "/dashboard/settings", icon: <IoSettings size={20} /> },
];
  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div className="flex h-full">
        ...
        <aside
          className={clsx(
            "fixed top-0 left-0 h-full w-64 bg-[#F3F4F6] shadow-2xl z-40 p-6 space-y-4 transform transition-transform duration-300",
